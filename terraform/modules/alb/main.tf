...
resource "aws_lb" "mindful-motion-lb" {
  ...
  #   security_groups = [module.security_groups.security_group_id_alb] //cant call module from inside
  ...
  #   subnets = [module.vpc.subnet1_id, module.vpc.subnet2_id] //cant call module from inside now
...
resource "aws_lb_target_group" "alb-tg-M" {
  ...
  #   vpc_id = module.vpc.vpc_id //cant call module from inside
